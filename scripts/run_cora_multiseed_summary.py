...
def train_clustergcn_return_probs(model, data, epochs, lr, weight_decay):
...
def main():
    ...
    for fraction in args.fractions:
        data = sample_cora_subgraph(full_data, fraction=fraction, seed=args.graph_seed)

        print("\n" + "=" * 88)
        print(f"Cora fraction={fraction} | nodes={data.num_nodes} | edges={data.num_edges}")
        print("=" * 88)
            ...
            for seed in args.seeds:
                ...
                if model_name == "gat":
                    ...
                    if model_name == "graphsage":
                        result = train_full_batch_return_probs(
                            model, data, args.epochs, args.lr, args.weight_decay
                        )
    ...
    print("\n" + "=" * 110)
    print("CORA MULTI-SEED BIAS-VARIANCE SUMMARY")
    print("=" * 110)
    print(
