...
GraphSAGE, GraphSAINT, and Cluster-GCN are implemented through the shared model/training pipeline. GAT is implemented separately using PyTorch Geometric's `GATConv`.
...
src/
  ...
  models.py                    # GraphSAGE and Cluster-GCN model definitions
